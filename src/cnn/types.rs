...
static MODEL_XML_PATH: &'static str = "./tests/yolov8n_openvino_model_fp16/yolov8n.xml";
static MODEL_WEIGHTS_PATH: &'static str = "./tests/yolov8n_openvino_model_fp16/yolov8n.bin";
...
pub fn run() -> Result<(), Error> {
    ...
    let tensors = convert("./tests/images/bus.jpg", &Dimensions::new(640, 640, 3, Precision::FP32))?;
    ...
    println!("{:#?}", output.tensor_desc()?.dims());
    println!("{:#?}", now.elapsed());
